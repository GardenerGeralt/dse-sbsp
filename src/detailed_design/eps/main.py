...
def sizing_EPS():
    ...
    bus_power = pb(p_aocs_ecl=84.9, p_cdh_ecl=0, p_gnc_ecl=0, p_prop_ecl=0, p_ther_ecl=0, p_struct_ecl=0,
    ...
    masses = pm(shunt_mass=2.4, cable_sp_mass=4.4, L_cables=20, batteries_mass=total_battery_mass, PMAD_mass=27,
                dry_mass=545.78, harness_frac=0.03, n_conv=160, m_conv=0.215)
