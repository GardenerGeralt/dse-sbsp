...
def sizing_EPS():
    ...
    #              DoD=0.4, bat_eff=0.9, t_mission=25, t_orb=26.93, m_battery=18)
    ...
    return bus_power, battery_mass, battery_volume, n_discharges, n_batteries, n_batteries, \
        production_energy, total_battery_mass

def printing():
    bus_power, battery_mass, battery_volume, n_discharges, n_batteries, n_batteries, \
        production_energy, total_battery_mass = sizing_EPS()
